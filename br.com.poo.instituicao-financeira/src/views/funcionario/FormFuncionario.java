...
public class FormFuncionario extends JPanel {
	...
	public FormFuncionario(JFrame telaAtualiza) {
	...
	private void cadastraFuncionario() {
		try {
			...
			gerente = new Gerente(nomeFuncionario, cpfFuncionario, enderecoFuncionario, estadoCiv, dataNasc, dataAd,
					sexo, possuiCurso, nomeCurso);
