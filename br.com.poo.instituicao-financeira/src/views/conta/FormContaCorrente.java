...
public class FormContaCorrente extends JPanel {
    ...
    public FormContaCorrente() {
        ...
        JTextField campoLimiteCheque = new JTextField();
        campoLimiteCheque.setPreferredSize(new Dimension(100, 30));
        JLabel limiteCheque = adicionarLabel("Limite Cheque Especial:");
        add(limiteCheque);
